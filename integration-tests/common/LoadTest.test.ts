...
describe("Load Test for ECONNRESET", () => {
  ...
  test(`should handle ${CONCURRENT_REQUESTS} staggered GET requests (1 every 1ms) without ECONNRESET`, async () => {
    ...
    console.log(
      `Sending ${CONCURRENT_REQUESTS} staggered requests (1 every 1ms)...`
    );
