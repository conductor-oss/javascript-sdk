...
import {
  ...
  // Full pipeline
  fullPipeline,
} from "../../../examples/agents/kitchen-sink.js";

import { Agent } from "../agent.js";
import { RegexGuardrail, LLMGuardrail } from "../guardrail.js";
import { GPTAssistantAgent } from "../ext.js";
import {
  TextMention,
  MaxMessage,
  TokenUsageCondition,
...
import { OnToolResult, OnTextMention, OnCondition, TextGate } from "../handoff.js";
...
describe("Stage 7: Publishing Pipeline", () => {
  ...
  it("publishing pipeline has composable termination", () => {
    ...
    const andConditions = conditions[1].conditions as Record<string, unknown>[];
